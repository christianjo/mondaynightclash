...
namespace mondaynightclash
{
	...
	public class CustomImplementedNav : Xamarin.Forms.MasterDetailPage, IFreshNavigationService
	{
		...
		void SetupTabbedPage()
		{
			...
			_contactsPage = _tabbedNavigationPage.AddTab<AllPlayersListPageModel>("Contacts", null);
			_quotesPage = _tabbedNavigationPage.AddTab<SelectPlayersListPageModel>("Quotes", null);
			...
			listView.ItemSelected += async (sender, args) =>
			{
				...
				switch ((string)args.SelectedItem)
				{
					...
					case "Quotes":
						...
						break;
					case "Modal Demo":
						var modalPage = FreshPageModelResolver.ResolvePageModel<PlayerPageModel>();
